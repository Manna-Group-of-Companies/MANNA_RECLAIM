      ...
      return ListView(
        children: const [
          ...
          EmptyState(
            ...
            hint:
                'Finish a run on R4, a coarse R2 shift or a grinder shift and '
                'it lands here.',
          ),
        ],
      );
        ...
        children: [
          ...
          if (runs.pendingWeigh.isEmpty)
            const EmptyState(
              ...
              title: 'Nothing to weigh',
              hint:
                  'Everything that has come off the machines is on the scale '
                  'record below.',
            )
          else
            CardGrid(
                ...
                for (final run in runs.pendingWeigh)
                  Panel(
                    ...
                    child: Row(
                      children: [
                        Expanded(
                          child: _RunLine(run: run, sub: _pendingSub(run)),
                        ),
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  if (runs.weighedTotal > runs.weighed.length ||
                      runs.weighedAll)
                    AppButton(
                      dense: true,
