      ...
      return ListView(
        children: const [
          ...
          EmptyState(
            ...
            hint:
                'Charge an autoclave with a special formulation on the Machines '
                'tab to start one — coarse and DRC loads are counted by their '
                'runs instead. Closed batches drop off here automatically and '
                'stay on the dispatch and history record.',
          ),
        ],
      );
    }
    ...
    return RefreshIndicator(
      ...
      child: ListView(
        ...
        children: [
          ViewHead(
            title: 'Batches',
            meta: Text('${store.items.length} active'),
          ),
          for (final batch in store.items)
            _BatchCard(
              batch: batch,
              held: store.held.contains(batch.ref),
              lockedReason: _lockedReason,
              onToggle: _toggle,
              ...
              Expanded(
                child: Wrap(
                  ...
                  children: [
                    ...
                    if (batch.formulation != null)
                      FormChip(batch.formulation!),
                        ...
                        child: Row(
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: row.marked ? T.brand : Colors.transparent,
