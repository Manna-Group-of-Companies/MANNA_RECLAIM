...
import { RunFullRecord } from '@/features/history/RunRecord';
import {
  buildPayload,
  changedFields,
  deletedSummary,
    ...
    return (
      <>
        ...
        {/* The record itself, shared with the back office and the managing
            director rather than written out on each of the three screens - see
            RunRecord for why one copy matters here. */}
        <RunFullRecord run={run} machineName={machine?.name} />
      </>
    );
  };
