...
const qualities = <String>['Special', 'SuperFine', 'Fine', 'Medium', 'DRC'];
...
/// everywhere else. The API counts the same set.
...
/// Only a special charge does: a coarse charge feeds the coarse line for the
/// shift and a DRC charge is counted by its runs. The API applies the same rule
/// and refuses either.
...
/// Seven grades the crew picks by colour before they read the name. Laid out
